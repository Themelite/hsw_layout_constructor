<?php
/*
  Plugin Name: Themelite Layout Constructor
  Plugin URI: http://sellweb.in
  Description: Universal Layout Constructor (Haswell)
  Author: Themelite
  Version: 1.0.1
...
class TMM_Ext_LayoutConstructor {
	...
	public static function admin_init() {
		...
		add_meta_box("tmm_layout_constructor", __("Theme Lite Layout Constructor", 'tmm_layout_constructor'), array(__CLASS__, 'draw_page_meta_box'), "page", "normal", "high");
		add_meta_box("tmm_layout_constructor", __("Theme Lite Layout Constructor", 'tmm_layout_constructor'), array(__CLASS__, 'draw_page_meta_box'), "post", "normal", "high");
		
		if (class_exists('TMM_Portfolio')) {
			add_meta_box("tmm_layout_constructor", __("Theme Lite Layout Constructor", 'tmm_layout_constructor'), array(__CLASS__, 'draw_page_meta_box'), TMM_Portfolio::$slug, "normal", "high");
		}
	}
